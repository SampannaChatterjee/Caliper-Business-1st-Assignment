...
public class SellerController {
	...
	public ResponseEntity<Seller> updateSellerController(@PathVariable Integer sellerId,@PathVariable String name,@PathVariable Integer contact, @PathVariable String address,@PathVariable List<Product> plist){
	...
	public ResponseEntity<Seller> deleteSellerController(@PathVariable Integer sellerId){
		Seller s=sService.deleteSeller(sellerId);
		return new ResponseEntity<Seller>(s,HttpStatus.ACCEPTED);
	}
	
	@GetMapping("/getSeller/{sellerId}")
	public ResponseEntity<Seller> getSellerController(@PathVariable Integer sellerId){
		Seller s=sService.viewSeller(sellerId);
		return new ResponseEntity<Seller>(s,HttpStatus.ACCEPTED);
