...
public class BuyerController {
	...
	public ResponseEntity<Buyer> deleteBuyerController(@PathVariable Integer buyerId){
		Buyer b=bService.deleteBuyer(buyerId);
		return new ResponseEntity<Buyer>(b,HttpStatus.ACCEPTED);
	}
	
	@GetMapping("/get/{buyerId}")
	public ResponseEntity<Buyer> getBuyerByIdController(@PathVariable Integer buyerId){
		Buyer b=bService.getBuyer(buyerId);
		return new ResponseEntity<Buyer>(b,HttpStatus.ACCEPTED);
	}
